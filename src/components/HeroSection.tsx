    ...
    <section className="relative min-h-[600px] overflow-hidden bg-primary md:min-h-[700px]">
      ...
      <div className="container relative mx-auto px-4 py-16 md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          {/* Subtitle */}
          <p
            className="mx-auto mt-6 max-w-2xl font-body text-lg text-primary-foreground/80 md:text-xl animate-slide-up"
          ...
          {/* Stats */}
          <div className="mt-12 grid grid-cols-1 sm:grid-cols-2 gap-8 justify-center text-center max-w-md mx-auto md:max-w-2xl">
            <div>
              <p className="font-sans-3xl font-bold text-primary-foreground md:text-4xl">
                1k+
              </p>
