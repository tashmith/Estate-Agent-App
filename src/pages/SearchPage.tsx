...
const SearchPage = () => {
  ...
  const filterProperties = () => {
    let results = propertiesData.properties as Property[];
  ...
  const handleDragOverFavourites = (e: React.DragEvent) => {
    e.preventDefault();
  ...
  const handleDropOnFavourites = (e: React.DragEvent) => {
    e.preventDefault();
    setIsDragOverFavourites(false);
    
    const propertyId = e.dataTransfer.getData("propertyId");
    if (propertyId) {
      const property = [...searchResults, ...(propertiesData.properties as Property[])].find(
        (p) => p.id === propertyId
      );
      if (property) {
                          ...
                          >
                            ...
                            >
                              ...
                              <div className="p-4">
                                ...
                                <p className="mt-2 font-sans text-xl font-bold text-accent">
