...
const PropertyDetail = () => {
  ...
  const formatDate = (added: { month: string; day: number; year: number }) => {
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pb-16 md:pb-24">
        ...
        <div className="container mx-auto px-4 py-4">
          <Link
            to="/properties"
            className="inline-flex items-center gap-2 font-body text-sm font-medium black color hover:black color"
          >
